...
import DepositItem, { depositsData } from '../components/DepositItem';
import DepositsImportantInfo from '../components/DepositsImportantInfo'; // Ուղղված ճանապարհը դեպի components
...
export default function Deposits() {
  ...
  return (
    <div className="w-full bg-white min-h-screen">
      ...
      {/* Ներքին էջերի երթուղիներ */}
      <Routes>
        {/* Հիմնական Ավանդների էջը */}
        <Route
          path="/"
          element={
            <div className="max-w-[1400px] mx-auto px-8 pt-10 pb-16">
              ...
              <div className="text-sm text-gray-500 mb-10 flex items-center space-x-2.5 font-normal">
                ...
                <span className="text-gray-300 text-xs">›</span>
                <span className="text-gray-900 font-medium cursor-default">Ավանդներ</span>
              </div>
        ...
        {/* Կարևոր տեղեկատվության ենթաէջը (components-ից) */}
        <Route path="/important-information" element={<DepositsImportantInfo />} />
      </Routes>
    </div>
  );
}
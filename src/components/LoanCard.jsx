...
export default function LoanCard({ loan }) {
  ...
  return (
    <div className="w-full py-8 border-b border-gray-100 flex flex-col lg:flex-row items-start gap-8">
      ...
      <div className="flex-1 flex flex-col justify-between min-h-[261px]">
        <div>

...
//   '/hy/loans/credit-history': 'Վարկային պատմություն և սքոր | Էվոկաբանկ', // 👈 Ավելացված է
//   '/loans/credit-history': 'Վարկային պատմություն և սքոր | Էվոկաբանկ',      // 👈 Ավելացված է
...
const pageTitles = {
  ...
  '/hy/loans/important-info': 'Կարևոր տեղեկատվություն | Էվոկաբանկ', // 👈 Ավելացված է
  '/loans/important-info': 'Կարևոր տեղեկատվություն | Էվոկաբանկ',      // 👈 Ավելացված է
  '/cards': 'Քարտեր | Էվոկաբանկ',
  '/hy/cards': 'Քարտեր | Էվոկաբանկ',
  '/deposits': 'Ավանդներ | Էվոկաբանկ',
  '/hy/deposits': 'Ավանդներ | Էվոկաբանկ',

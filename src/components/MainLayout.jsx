...
//   '/cards/issuance-service': 'Քարտերի տրամադրում և սպասարկում | Էվոկաբանկ', // 👈 Ավելացված է
//   '/hy/cards/issuance-service': 'Քարտերի տրամադրում և սպասարկում | Էվոկաբանկ', // 👈 Ավելացված է
...
const pageTitles = {
  ...
  '/cards/social-security': 'Սոցիալական ապահովության վճարային քարտեր | Էվոկաբանկ', // 👈 Ավելացված է
  '/hy/cards/social-security': 'Սոցիալական ապահովության վճարային քարտեր | Էվոկաբանկ', // 👈 Ավելացված է
  '/deposits': 'Ավանդներ | Էվոկաբանկ',
  '/hy/deposits': 'Ավանդներ | Էվոկաբանկ',
  '/accounts': 'Հաշիվներ | Էվոկաբանկ',
  '/hy/accounts': 'Հաշիվներ | Էվոկաբանկ',

...
import SocialSecurityCards from './components/SocialSecurityCards';
import Deposits from './pages/Deposits';
import DepositsImportantInfo from './components/DepositsImportantInfo'; // 👈 Ավելացված է
import Accounts from './pages/Accounts';
import UnallocatedMetalAccounts from './components/UnallocatedMetalAccounts';
import NonResident from './components/NonResident';
import SafeBoxes from './components/SafeBoxes';
    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<MainLayout />}>
          ...
          <Route path="deposits" element={<Deposits />} />
          <Route path="hy/deposits" element={<Deposits />} />
          <Route path="deposits/important-information" element={<DepositsImportantInfo />} />      {/* 👈 Ավելացված է */}
          <Route path="hy/deposits/important-information" element={<DepositsImportantInfo />} />  {/* 👈 Ավելացված է */}
          ...
          <Route path="hy/transfers/payment-systems" element={<PaymentSystems />} />
